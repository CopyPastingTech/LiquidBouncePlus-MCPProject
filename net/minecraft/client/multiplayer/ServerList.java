...
public class ServerList
{
    ...
    public ServerData getServerData(int index)
    {
        try {
            ...
            mc.logger.error("Failed to get server data.", e);
            return null;
        }
    }
    ...
    public void removeServerData(int index)
    {
        try {
            ...
            mc.logger.error("Failed to remove server data.", e);
        }
    }
    ...
    public void addServerData(ServerData server)
    {
        try {
            ...
            mc.logger.error("Failed to add server data.", e);
        }
    }
    ...
    public void swapServers(int p_78857_1_, int p_78857_2_)
    {
        try {
            ...
            mc.logger.error("Failed to swap servers.", e);
        }
    }
    ...
    public void func_147413_a(int index, ServerData server)
    {
        try {
            ...
            mc.logger.error("Failed to set server data.", e);
        }
    }
