...
{
    private static Map<World, List<BlockRedstoneTorch.Toggle>> toggles = /*Maps.<World, List<BlockRedstoneTorch.Toggle>>newHashMap()*/new WeakHashMap<>(); // We use weak hasmap here instead so GC can work and reduce allocated memory.
